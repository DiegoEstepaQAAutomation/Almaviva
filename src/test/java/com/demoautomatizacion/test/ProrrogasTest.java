...
//////////////////////////////	
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar en prórroga para tipo de titulo \"Certificado deposito de mercancía\" funcionalidad campo \"Plazo del deposito\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar en prórroga para tipo de titulo \"Certificado deposito de mercancía\" funcionalidad campo \"Nueva fecha plazo de deposito\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar en prórroga para tipo de titulo \"Certificado deposito de mercancía\" funcionalidad campo \"Fecha de certificado\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b44() throws Exception {
		...
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("tituloCertificado"))
		.SeleccionarCodigoTitulo().CDM();
		ValidacionProrrogas.ValidarFechaCredito("Fecha de certificado:");
		home.Exit();

	}
	
	@Test(priority = 46, description = "Caso 45")
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar en prórroga para tipo de titulo \"Certificado deposito de mercancía\" funcionalidad campo \"Plazo del certificado\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b45() throws Exception {
		...
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("tituloCertificado"))
		.SeleccionarCodigoTitulo().CDM();
		ValidacionProrrogas.ValidarPlazoCredito("Plazo del certificado");
		Prorrogas.PlazoCertificado(getProperties().getProperty("NumeroDias")).ClearPlazoCertificado()
		.PlazoCertificado(getProperties().getProperty("Titulo"));
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar en prórroga para tipo de titulo \"Certificado deposito de mercancía\" funcionalidad campo \"Nueva fecha plazo de certificado\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b46() throws Exception {
		...
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("tituloCertificado"))
		.SeleccionarCodigoTitulo().CDM();
		ValidacionProrrogas.ValidarNFPC("Nueva fecha plazo de certificado");
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar en formulario del tipo de título grilla con el campo \"Fecha Prórroga\" \"Certificado deposito de mercancía\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b47() throws Exception {
		...
		login.ingresarCredenciales1(getProperties().getProperty("usuario"), getProperties().getProperty("password"));
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("TituloCertificado"))
		.SeleccionarCodigoTitulo().CDM().ScrollAbajo();
		ValidacionProrrogas.ValidarFechaProrroga("Fecha prorroga");
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar en formulario del tipo de título grilla con el campo \"Días\" \"Certificado deposito de mercancía\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b48() throws Exception {
		...
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("TituloCertificado"))
		.SeleccionarCodigoTitulo().CDM().ScrollAbajo();
		ValidacionProrrogas.ValidarDias2("Días");
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar en formulario del tipo de título grilla con el campo \"Fecha nueva\" \"Certificado deposito de mercancía\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b49() throws Exception {
		...
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("TituloCertificado"))
		.SeleccionarCodigoTitulo().CDM().ScrollAbajo();
		ValidacionProrrogas.ValidarFechaNueva("Fecha nueva");
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar que no permita realizar Prórroga cuando el cupo está vencido \"Certificado deposito de mercancía\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b50 () throws Exception {
		home.irPortal(getProperties().getProperty("url"));
		login.ingresarCredenciales1(getProperties().getProperty("usuario"), getProperties().getProperty("password"));
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("tituloCupoVencidoC"))
		.SeleccionarCodigoTitulo().CDM().PlazoDeposito(getProperties().getProperty("NumeroDias")).ScrollAbajo()
		.PlazoCertificado(getProperties().getProperty("NumeroDias")).ScrollAbajo1().BotonGuardar().BotonAceptar();
		ValidacionProrrogas.ValidarCupoVencido("Cupo se encuentra vencido");
		Prorrogas.BotonAceptar();
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar que permita realizar Prórroga cuando el titulo está vencido \"Certificado deposito de mercancía\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b51 () throws Exception {
		home.irPortal(getProperties().getProperty("url"));
		login.ingresarCredenciales1(getProperties().getProperty("usuario"), getProperties().getProperty("password"));
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("tituloVencidoC"))
		.SeleccionarCodigoTitulo().CDM().PlazoDeposito(getProperties().getProperty("NumeroDias")).ScrollAbajo()
		.PlazoCertificado(getProperties().getProperty("NumeroDias")).ScrollAbajo1().BotonGuardar().BotonAceptar();
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar funcionalidad de botón \"guardar\" \"Certificado deposito de mercancía\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b52 () throws Exception {
		...
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("tituloVencidoC"))
		.SeleccionarCodigoTitulo().CDM().PlazoDeposito(getProperties().getProperty("NumeroDias")).ScrollAbajo()
		.PlazoCertificado(getProperties().getProperty("NumeroDias")).ScrollAbajo1().BotonGuardar().BotonCancelar1();
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar en ventana emergente de guardar funcionalidad de los botones \"Aceptar\" y \"Cancelar\"  \"Certificado deposito de mercancía\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar funcionalidad botón \"Cancelar\" \"Certificado deposito de mercancía\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b54 () throws Exception {
		...
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("tituloVencidoC"))
		.SeleccionarCodigoTitulo().CDM().PlazoDeposito(getProperties().getProperty("NumeroDias")).ScrollAbajo()
		.PlazoCertificado(getProperties().getProperty("NumeroDias")).ScrollAbajo1().BotonCancelar();
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Valida paginado \"Certificado deposito de mercancía\"")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b55 () throws Exception {
		...
		login.ingresarCredenciales1(getProperties().getProperty("usuario"), getProperties().getProperty("password"));
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("tituloVencidoC"))
		.SeleccionarCodigoTitulo().CDM().ScrollAbajo1().Screenshot().PaginacionC();
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar que en la consulta no se diferencie entre mayúsculas y minúsculas")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b56 () throws Exception {
		home.irPortal(getProperties().getProperty("url"));
		login.ingresarCredenciales1(getProperties().getProperty("usuario"), getProperties().getProperty("password"));
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("Mym"));
		home.Exit();
	...
	@Severity(SeverityLevel.NORMAL)
	@Description("Validar que no permita realizar solicitud de Prórroga si el formulario  no cumple con los parámetros")
	@Story("Liberación de Mercancía")
	@TmsLink("XRPRJ-1")
	public void b58 () throws Exception {
		...
		login.ingresarCredenciales1(getProperties().getProperty("usuario"), getProperties().getProperty("password"));
		Prorrogas.Titulo().Prorrogar().CodigoTitulo(getProperties().getProperty("tituloVencidoC"))
		.SeleccionarCodigoTitulo().CDM().ScrollAbajo1().BotonGuardar().BotonAceptar().BotonAceptar();
		home.Exit();
